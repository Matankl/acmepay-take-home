"""
baseline_system.py — the ORIGINAL starter, kept verbatim for the "before" column.

Only change from git HEAD:system.py is the data path, so it can live in scripts/.
Run it with:  python -m scripts.sweep --system scripts.baseline_system --baseline
